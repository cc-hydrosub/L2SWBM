...
erieOutflow_Prior[,4] = erieOutflow_Prior[,4] - erieDiversion_Prior[,3] #original version did not exist
...
for(i in 1:12){
	...
	erieNBSPriorMean[i] =  mean(erieNBS_Prior[erieNBS_Prior[,2]==i,priorNBSColumn], na.rm=TRUE)
	erieNBSPriorPrecision[i] = (1/var(erieNBS_Prior[erieNBS_Prior[,2]==i,priorNBSColumn], na.rm=TRUE))	
	...
	ontarioNBSPriorMean[i] =  mean(ontarioNBS_Prior[ontarioNBS_Prior[,2]==i,priorNBSColumn], na.rm=TRUE)
	ontarioNBSPriorPrecision[i] = (1/var(ontarioNBS_Prior[ontarioNBS_Prior[,2]==i,priorNBSColumn], na.rm=TRUE))	

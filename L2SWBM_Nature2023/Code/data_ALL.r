...
#Come back here these lines of code need to be commented until transition is made. In the original version none of these lines were being executed
#erieOutflow<-na.omit(erieOutflow)
#erieDiversion<-na.omit(erieDiversion)
